...
- [pySHACL](https://github.com/rdflib/pyshacl) <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/rdflib/pyshacl" align="top"> - pySHACL: A Python validator for SHACL. One of the most comprehensive SHACL implementations. This module uses the [RDFLib library](https://github.com/rdflib/rdflib) for working with RDF and is dependent on the [OWL-RL library](https://github.com/rdflib/owl-rl) for OWL2 RL Profile-based expansion of data graphs; `Apache` license; `Python`.
